...
const API_URL =
  "https://raw.githubusercontent.com/Supremeduck3/rec-eduardo/refs/heads/main/db.json";
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.headerText}>Paises da copa</Text>
      </View>
...
const styles = StyleSheet.create({
  ...
  header: { backgroundColor: "#018d2b", padding: 20, alignItems: "center" },
